    ...
    <section className="w-sevenEightWidth h-fit flex flex-col items-start gap-y-5">
      ...
      <div className="w-full flex flex-col gap-y-[14px]">
        <div className="w-full flex justify-between items-center">
          ...
          <span className="caption2 text-grey6">{reservationPrice}</span>
        </div>
        <div className="w-full flex justify-between items-center">
          <span className="caption2 text-grey4">수수료</span>
          <span className="caption2 text-grey6">{feePrice}</span>
        </div>
        <div className="w-full flex justify-between items-center">
          <span className="caption2 text-grey4">쿠폰 할인</span>
          <span className="caption2 text-grey6">{couponDiscountPrice}</span>
        </div>
      </div>
    </section>
  );
